...
public class PlayerController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            Debug.Log("Testing animation - setting to walk NE");
            characterRenderer.SetDirection(new Vector2(1, 1));
        }
        
        // DON'T set to idle in Start - let's see if the walk animation shows
    ...
    {
        Debug.Log($"UpdateAnimationDirection called with: {dir}, magnitude: {dir.magnitude}");
        if (characterRenderer != null)
        {
        ...
        {
            Debug.LogWarning("characterRenderer is NULL!");
        }
    }
    ...
    private System.Collections.IEnumerator MoveToCell(Vector3Int targetCell)
    {
        ...
        Debug.Log("MOVEMENT COMPLETE - Waiting before idle");
        
        // Now it's safe to set to idle
        UpdateAnimationDirection(Vector2.zero);
